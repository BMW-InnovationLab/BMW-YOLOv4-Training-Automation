...
app: FastAPI = FastAPI(
    ...
    description='<b>API for Monitoring YOLO Training <br><br><br>Contact the developers:<br><font color="#808080">Nour Azzi: <a href="https://github.com/nourazzii"></a>https://github.com/nourazzii<br>Lynn Nassif: <a href=""></a><br>BMW Innovation Lab: <a href="mailto:innovation-lab@bmw.de">innovation-lab@bmw.de</a></font></b>',
    docs_url="/",
    version="3.1.0",
)
